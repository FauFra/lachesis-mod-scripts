...
BASIC_VARIANT_ORDER = ['OS', 'LACHESIS', 'LACHESIS-MOD', 'LACHESIS-NICE', 'LACHESIS-MOD-NICE', 'LACHESIS-MOD-RT', 'LACHESIS-CPUSHARE', 'HAREN', 'EDGEWISE', 'RANDOM']
# Figures 
...
def latency_percentile_box(parameter='latency', rates=(-np.inf, np.inf), legend=True, ncol=3, bbox=(0.8, 0), bottom=0.25, export=False):
    query_names = {'StormVoipStreamKafka': 'b) VS – Storm', 'StormLinearRoadKafka': 'a) LR – Storm',
                   ...
                   'StormLinearRoadKafkaOsNiceCPUShare': 'e) LR - Storm (nice, cpu.share)'
                  }
